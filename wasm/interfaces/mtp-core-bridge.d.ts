/** @module Interface mtp:core/bridge@0.2.0 **/
...
export function fireEvent(slot: number, event: string, args: Array<ArgValue>): ExecutionResult;
...
export function getGlobalValue(slot: number, key: string): ConfigValue | undefined;
export function setGlobalValue(slot: number, key: string, value: ConfigValue): boolean;
export function resetGlobals(slot: number): boolean;
